...
from train1 import get_batch, model_initialization, addpaddings, find_max_block_numbers, initGlobalEncoderInput
...
def evaluate(valid_set, langs, embedding_size,
    ...
    for dt in valid_iter:
        ...
        # # Compare to the origin data
            ...
            plt.savefig('output/'+ Model_name+'_'+str(iteration)+'.png')
        yield res
